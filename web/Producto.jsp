                ...
                <div class="card-body">
                    <form action="Controlador?menu=Producto" method="POST">
                        <div class="form-group">
                            <label>Nombres</label>
                            <input type="text" value="${producto.getNombre()}" name="txtNombres" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label>Precio</label>
                            <input type="number" value="${producto.getPrecio()}" name="txtPrecio" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label>Stock</label>
                    ...
                    <c:forEach var="prod" items="${list}" >
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger" href="Controlador?menu=Producto&accion=Delete&id=${prod.getId()}">Delete</a>
                            </td>
                        </tr>
                    </c:forEach> 
                    </tbody>
