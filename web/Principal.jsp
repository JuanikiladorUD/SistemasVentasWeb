            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton">
                        ...
                        <img src="img/usuario.png" alt="Icono-Usuario" height="50" width="50"/>
                        <a class="dropdown-item" href="#">${usuario.getUser()}</a>
                        <a class="dropdown-item" href="#">${usuario.getNom()}</a>
                        <div class="dropdown-divider"></div>
                        <form action="Controlador?menu=Salir" method="post">
                            <button name="accion" value="salir" class="dropdown-item" href="#" target="myFrame" >Salir</button>
                        </form>
                    </div>
                </div>
            </div>
