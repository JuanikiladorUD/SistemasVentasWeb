            ...
            <div class="card col-sm-5">
                <div class="card-body">
                    <form action="Controlador?menu=Cliente" method="POST">
                        ...
                        <div class="form-group">
                            <label>Nombres</label>
                            <input type="text" value="${cli.getNom()}" name="txtNombres" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label>Estado</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="${cli.getDireccion()}" name="txtDireccion" class="form-control" required="">
                        </div>
                        <input type="submit" name="accion" value="Agregar" class="btn btn-info" href="Controlador?menu=Cliente&accion=Agregar" >
